...
export default function Auth() {
  ...
  const handleSubmit = (e) => {
    ...
    if (isLogin) {
      ...
      if (result.success) {
        addToast('Account created! Welcome to NutriBerg 🎉', 'success');
        navigate('/');
      } else {
        setError(result.error);
      }
  ...
  return (
    <div className="auth-page">
      <div className="auth-card animate-scale-in">
        ...
        {error && (
          <div className="badge badge-danger mb-md" style={{
            display: 'block', padding: 'var(--space-sm) var(--space-md)',
            borderRadius: 'var(--radius-sm)', textAlign: 'center', width: '100%',
          }}>
            {error}
          </div>
        )}
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          {isLogin && (
            <div className="text-right">
              <a className="text-sm" style={{ cursor: 'pointer' }}>Forgot password?</a>
            </div>
          )}
        ...
        <div className="grid grid-2 gap-sm">
          <button className="btn btn-secondary" onClick={() => {
            login('demo@nutriberg.com', 'password123');
          ...
          <button className="btn btn-secondary" onClick={() => {
            login('demo@nutriberg.com', 'password123');
            addToast('Signed in with GitHub!', 'success');
            navigate('/');
          }}>
